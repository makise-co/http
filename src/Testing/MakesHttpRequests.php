...
namespace MakiseCo\Http\Testing;
...
trait MakesHttpRequests
{
    ...
    public function json($method, $uri, array $data = [], array $headers = []): TestResponse
    {
        ...
        $content = new StringStream(json_encode($data));
     ...
     * @param array $files
     * @param array $headers
     * @param string|null|StringStream $content
     * @return TestResponse
     */
    public function call(
        ...
        if ($this->requestHandler === null) {
            /** @var \MakiseCo\Http\RequestHandler\RequestHandlerFactoryInterface $factory */
            $factory = $this->container->get(RequestHandlerFactoryInterface::class);
